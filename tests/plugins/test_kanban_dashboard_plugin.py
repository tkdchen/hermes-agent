...
def test_ws_events_rejects_when_token_required(tmp_path, monkeypatch):
    ...
    monkeypatch.setitem(sys.modules, "hermes_agent.hermes_cli.web_server", stub)
...
def test_ws_events_swallows_cancellation_on_shutdown(tmp_path, monkeypatch):
    ...
    # path, not auth.
    import hermes_agent.plugins.kanban.dashboard.plugin_api as pa
...
def test_create_task_includes_warning_when_no_dispatcher(client, monkeypatch):
    ...
    monkeypatch.setattr(
        "hermes_agent.hermes_cli.kanban._check_dispatcher_presence",
...
def test_board_endpoint_survives_task_age_exception(client, monkeypatch):
    ...
    monkeypatch.setattr("hermes_agent.hermes_cli.kanban_db.task_age", _boom)
...
def test_create_task_probe_error_does_not_break_create(client, monkeypatch):
    ...
    monkeypatch.setattr(
        "hermes_agent.hermes_cli.kanban._check_dispatcher_presence", _raise,
    )
    r = client.post(
        "/api/plugins/kanban/tasks",
