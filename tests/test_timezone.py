...
class TestCodeExecutionTZ:
    ...
    def _import_execute_code(self, monkeypatch):
        ...
        try:
            ...
            pytest.skip("hermes_agent.tools.code_execution_tool not importable (missing deps)")
    ...
    def test_tz_injected_when_configured(self):
        ...
        with patch("hermes_agent.model_tools.handle_function_call", side_effect=self._mock_handle):
