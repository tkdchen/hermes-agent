...
class TestCallServiceStringData:
    ...
    @patch("hermes_agent.tools.homeassistant_tool._run_async", return_value={"success": True})
...
class TestGetHeaders:
    def test_bearer_token_format(self, monkeypatch):
        monkeypatch.setattr("hermes_agent.tools.homeassistant_tool._HASS_TOKEN", "my-secret-token")
