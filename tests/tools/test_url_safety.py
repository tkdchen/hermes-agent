...
class TestIsSafeUrl:
    ...
    def test_unexpected_error_fails_closed(self):
        ...
        with patch("hermes_agent.tools.url_safety.urlparse", side_effect=ValueError("bad url")):
...
class TestGlobalAllowPrivateUrls:
    ...
    def test_default_is_false(self, monkeypatch):
        ...
        with patch("hermes_agent.hermes_cli.config.read_raw_config", side_effect=Exception("no config")):
