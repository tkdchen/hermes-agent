...
class TestMimeExtension:
    def test_maps_jpeg_variants_to_jpg(self):
        from hermes_agent.tools.mcp_tool import _mcp_image_extension_for_mime_type
...
class TestCacheMcpImageBlock:
    def test_returns_media_tag_for_valid_image_block(self, tmp_path, monkeypatch):
        ...
        from hermes_agent.tools.mcp_tool import _cache_mcp_image_block
        ...
        from hermes_agent.gateway.platforms.base import get_image_cache_dir
