...
class TestWebServerEndpoints:
    ...
    def test_get_media_requires_auth(self):
        from hermes_agent.hermes_cli.web_server import _SESSION_HEADER_NAME
    ...
    def test_get_sessions_forwards_min_messages(self, monkeypatch):
        ...
        monkeypatch.setattr("hermes_agent.hermes_state.SessionDB", _FakeDB)
    ...
    def test_audio_transcription_endpoint(self, monkeypatch):
        import hermes_agent.tools.transcription_tools as transcription_tools
    ...
    def test_get_env_vars_marks_channel_managed_keys(self):
        from hermes_agent.hermes_cli.web_server import _channel_managed_env_keys
    ...
    def test_platform_scoped_messaging_env_vars_are_channel_managed(self):
        from hermes_agent.hermes_cli.web_server import (
    ...
    def test_model_set_requires_confirmation_for_expensive_model(self, monkeypatch):
        monkeypatch.setattr(
            "hermes_agent.hermes_cli.model_cost_guard.expensive_model_warning",
    ...
    def test_reveal_env_var(self, tmp_path):
        ...
        from hermes_agent.hermes_cli.web_server import _SESSION_HEADER_NAME, _SESSION_TOKEN
    ...
    def test_reveal_env_var_legacy_authorization_header_still_works(self, tmp_path):
        ...
        from hermes_agent.hermes_cli.config import save_env_value
        from hermes_agent.hermes_cli.web_server import _SESSION_TOKEN
    ...
    def test_messaging_catalog_includes_plugin_platforms(self, monkeypatch):
        ...
        from hermes_agent.gateway.platform_registry import PlatformEntry, platform_registry
    ...
    def test_update_messaging_platform_saves_env_and_enablement(self):
        from hermes_agent.hermes_cli.config import load_config, load_env
    ...
    def test_set_model_main_nous_applies_gateway_defaults(self, monkeypatch):
        ...
        import hermes_agent.hermes_cli.nous_subscription as ns
    ...
    def test_apply_main_model_assignment_base_url_and_context_reconcile(self):
        ...
        from hermes_agent.hermes_cli.web_server import _apply_main_model_assignment
    ...
    def test_parse_model_ids_handles_openai_and_bare_shapes(self):
        ...
        from hermes_agent.hermes_cli.web_server import _parse_model_ids
    ...
    def test_recommended_default_nous_honors_free_tier(self, monkeypatch):
        ...
        import hermes_agent.hermes_cli.models as models_mod
...
class TestBuildSchemaFromConfig:
    def test_produces_expected_field_count(self):
        from hermes_agent.hermes_cli.web_server import CONFIG_SCHEMA
    ...
    def test_empty_prefix_produces_correct_keys(self):
        from hermes_agent.hermes_cli.web_server import _build_schema_from_config
...
class TestNewEndpoints:
    ...
    def test_profiles_list_falls_back_when_profile_listing_fails(self, monkeypatch):
        from hermes_agent.hermes_constants import get_hermes_home
        import hermes_agent.hermes_cli.profiles as profiles_mod
    ...
    def test_skills_list_includes_disabled_skills(self, monkeypatch):
        ...
        import hermes_agent.hermes_cli.skills_config as skills_config
        import hermes_agent.hermes_cli.web_server as web_server
    ...
    def test_toolsets_list_matches_cli_enabled_state(self, monkeypatch):
        ...
        import hermes_agent.toolsets as toolsets_module
        import hermes_agent.hermes_cli.web_server as web_server
...
class TestModelContextLength:
    ...
    def test_normalize_extracts_context_length_from_dict(self):
        ...
        from hermes_agent.hermes_cli.web_server import _normalize_config_for_web
    ...
    def test_denormalize_writes_context_length_into_model_dict(self):
        ...
        from hermes_agent.hermes_cli.web_server import _denormalize_config_from_web
...
class TestNormaliseThemeDefinition:
    ...
    def test_rejects_missing_name(self):
        from hermes_agent.hermes_cli.web_server import _normalise_theme_definition
...
class TestPtyWebSocket:
    ...
    def test_unavailable_platform_closes_with_message(self, monkeypatch):
        from hermes_agent.hermes_cli.pty_bridge import PtyUnavailableError
        ...
        import hermes_agent.hermes_cli.web_server as ws_mod
    ...
    def test_pub_broadcasts_to_events_subscribers(self):
        ...
        """
        import asyncio
        from hermes_agent.hermes_cli import web_server as ws_mod
