...
from hermes_agent.hermes_cli.model_normalize import normalize_model_for_provider, detect_vendor
from hermes_agent.agent.model_metadata import get_model_context_length
from hermes_agent.agent.models_dev import PROVIDER_TO_MODELS_DEV, list_agentic_models, _NOISE_PATTERNS
...
class TestGeminiContextLength:
    def test_gemma_4_31b_context(self):
        ...
        with patch("hermes_agent.agent.models_dev.lookup_models_dev_context", return_value=None), \
...
class TestGeminiAgentInit:
    ...
    def test_gemini_agent_uses_chat_completions(self, monkeypatch):
        ...
        with patch("hermes_agent.agent.gemini_native_adapter.GeminiNativeClient") as mock_client:
    ...
    def test_gemini_agent_uses_native_client(self, monkeypatch):
        ...
        with patch("hermes_agent.agent.gemini_native_adapter.GeminiNativeClient") as mock_client, \
             ...
             patch("hermes_agent.run_agent.ContextCompressor") as mock_compressor:
            mock_client.return_value = MagicMock()
...
class TestGeminiModelsDev:
    ...
    def test_list_provider_models_hides_low_tpm_google_gemmas(self):
        ...
        with patch("hermes_agent.agent.models_dev.fetch_models_dev", return_value=mock_data):
            from hermes_agent.agent.models_dev import list_provider_models
