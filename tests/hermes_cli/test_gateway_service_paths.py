...
def test_service_path_skips_nonexistent_node_modules(tmp_path):
    ...
    from hermes_agent.hermes_cli.gateway import _build_service_path_dirs
    with patch("hermes_agent.hermes_cli.gateway.get_hermes_home", return_value=tmp_path / ".hermes"):
