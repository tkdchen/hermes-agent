...
from hermes_agent.hermes_cli.codex_runtime_plugin_migration import (
    MIGRATION_MARKER,
...
class TestMigrate:
    ...
    def test_plugin_discovery_writes_plugin_blocks(self, tmp_path, monkeypatch):
        ...
        from hermes_agent.hermes_cli import codex_runtime_plugin_migration as crpm
    ...
    def test_plugin_discovery_skips_unavailable_plugins(self):
        ...
        from hermes_agent.hermes_cli.codex_runtime_plugin_migration import _query_codex_plugins
        ...
        with patch("hermes_agent.agent.transports.codex_app_server.CodexAppServerClient",
                   FakeClient):
...
class TestStripUnmanagedPluginTables:
    ...
    def test_migrate_dedups_codex_owned_plugin_tables(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "hermes_agent.hermes_cli.codex_runtime_plugin_migration._query_codex_plugins",
            fake_query,
        )
