...
from hermes_agent.hermes_cli.codex_models import DEFAULT_CODEX_MODELS, get_codex_model_ids
...
def test_setup_wizard_codex_import_resolves():
    ...
    from hermes_agent.hermes_cli.codex_models import get_codex_model_ids as setup_import
...
def test_fetch_from_api_keeps_supported_in_api_false_models(monkeypatch):
    ...
    """
    import sys
    from hermes_agent.hermes_cli import codex_models
...
def test_model_command_uses_runtime_access_token_for_codex_list(monkeypatch):
    from hermes_agent.hermes_cli.main import _model_flow_openai_codex
    ...
    monkeypatch.setattr(
        "hermes_agent.hermes_cli.auth.get_codex_auth_status",
...
def test_model_command_prompts_to_reuse_or_reauthenticate_codex_session(monkeypatch, capsys):
    ...
    monkeypatch.setattr("hermes_agent.hermes_cli.auth._login_openai_codex", _fake_login)
    monkeypatch.setattr(
        "hermes_agent.hermes_cli.codex_models.get_codex_model_ids",
...
def test_model_command_uses_existing_codex_session_without_relogin(monkeypatch):
    ...
    monkeypatch.setattr(
        "hermes_agent.hermes_cli.auth._login_openai_codex",
