...
class TestGetModelContextLengthHonorsOverride:
    """hermes_agent.agent.model_metadata.get_model_context_length must honor the
...
class TestContextProbeTiers:
    def test_256k_is_top_tier_and_default(self):
        ...
        from hermes_agent.agent.model_metadata import CONTEXT_PROBE_TIERS, DEFAULT_FALLBACK_CONTEXT
