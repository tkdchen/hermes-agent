...
class TestProviderModelIdsPreferred:
    ...
    def test_kimi_coding_live_catalog_does_not_hide_curated_k2_7_code(self):
        ...
        with (
            ...
            patch("hermes_agent.providers.base.ProviderProfile.fetch_models", return_value=["kimi-k2.6"]),
        ):
            out = provider_model_ids("kimi-coding")
    ...
    def test_kimi_setup_flow_uses_same_coding_plan_catalog(self):
        ...
        from hermes_agent.hermes_cli.model_setup_flows import _model_flow_kimi
        ...
        with (
            patch("hermes_agent.hermes_cli.main._prompt_api_key", return_value=("sk-kimi-test", False)),
            patch("hermes_agent.hermes_cli.auth._prompt_model_selection", side_effect=fake_select),
            patch("hermes_agent.hermes_cli.config.get_env_value", return_value=""),
...
class TestOpenRouterAndNousUnchanged:
    ...
    def test_openrouter_does_not_call_merge(self):
        ...
        with patch(
            "hermes_agent.hermes_cli.models._merge_with_models_dev",
