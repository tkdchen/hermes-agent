...
def isolated_home(tmp_path, monkeypatch):
    ...
    import importlib
    from hermes_agent.hermes_cli import model_catalog
...
class TestValidation:
    def test_accepts_well_formed_manifest(self, isolated_home):
        from hermes_agent.hermes_cli.model_catalog import _validate_manifest
...
class TestIntegrationWithModelsModule:
    ...
    def test_curated_nous_ids_falls_back_to_hardcoded_on_empty_catalog(
        ...
        from hermes_agent.hermes_cli import model_catalog
        from hermes_agent.hermes_cli.models import get_curated_nous_model_ids, _PROVIDER_MODELS
    ...
    def test_curated_nous_ids_prefers_manifest(self, isolated_home):
        from hermes_agent.hermes_cli import model_catalog
        from hermes_agent.hermes_cli.models import get_curated_nous_model_ids
    ...
    def test_picker_nous_row_uses_curated_list(self, tmp_path, monkeypatch):
        ...
        importlib.reload(model_catalog)
        try:
            from hermes_agent.hermes_cli.model_switch import list_picker_providers
            ...
            with patch.object(
                model_catalog, "_fetch_manifest", return_value=_valid_manifest()
            ), patch("hermes_agent.hermes_cli.models.check_nous_free_tier", return_value=False), patch(
                "hermes_agent.hermes_cli.models.union_with_portal_free_recommendations",
                side_effect=lambda ids, *a, **k: (ids, {}),
            ), patch(
                "hermes_agent.hermes_cli.models.union_with_portal_paid_recommendations",
                side_effect=lambda ids, *a, **k: (ids, {}),
            ):
