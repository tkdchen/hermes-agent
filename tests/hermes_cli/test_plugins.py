...
from hermes_agent.hermes_cli.middleware import (
    VALID_MIDDLEWARE,
...
class TestPluginHooks:
    ...
    def test_invalid_hook_name_warns(self, tmp_path, monkeypatch, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="hermes_agent.hermes_cli.plugins"):
            mgr = PluginManager()
            mgr.discover_and_load()
...
class TestPluginContext:
    ...
    def test_register_tool_override_replaces_existing(self, tmp_path, monkeypatch, caplog):
        ...
        try:
            ...
            with caplog.at_level(logging.INFO, logger="hermes_agent.tools.registry"):
                mgr = PluginManager()
                mgr.discover_and_load()
...
class TestPluginCommands:
    ...
    def test_get_plugin_command_handler_found(self):
        ...
        with patch("hermes_agent.hermes_cli.plugins._plugin_manager", mgr):
...
class TestPluginCommandResultResolution:
    ...
    def test_awaits_async_result_with_running_loop(self, monkeypatch):
        ...
        monkeypatch.setattr("hermes_agent.hermes_cli.plugins.asyncio.get_running_loop", lambda: _Loop())
    ...
    def test_running_loop_timeout_does_not_hang_forever(self, monkeypatch):
        ...
        monkeypatch.setattr("hermes_agent.hermes_cli.plugins.asyncio.get_running_loop", lambda: _Loop())
        monkeypatch.setattr("hermes_agent.hermes_cli.plugins._PLUGIN_COMMAND_AWAIT_TIMEOUT_SECS", 0.1)
...
class TestPluginDispatchTool:
    ...
    def test_dispatch_tool_calls_registry(self):
        ...
        with patch("hermes_agent.hermes_cli.plugins.PluginContext.dispatch_tool.__module__", "hermes_agent.hermes_cli.plugins"):
