...
def test_all_aux_tasks_includes_plugin_registered(patched_manager):
    from hermes_agent.hermes_cli.main import _AUX_TASKS, _all_aux_tasks
...
def test_all_aux_tasks_swallows_plugin_discovery_failure(monkeypatch):
    ...
    monkeypatch.setattr(
        "hermes_agent.hermes_cli.plugins.get_plugin_auxiliary_tasks", _broken
    )
...
def test_reset_aux_to_auto_resets_plugin_tasks(tmp_path, monkeypatch, patched_manager):
    ...
    from hermes_agent.hermes_cli.main import _reset_aux_to_auto
...
def test_get_auxiliary_task_config_layers_plugin_defaults(
    ...
    from pathlib import Path
    from hermes_agent.agent.auxiliary_client import _get_auxiliary_task_config
