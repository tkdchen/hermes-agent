...
class TestResolveProvider:
    ...
    def test_auto_detect_with_aws_credentials(self, monkeypatch):
        ...
        with patch("hermes_agent.hermes_cli.auth._load_auth_store", return_value={}):
...
class TestRuntimeProvider:
    ...
    def test_bedrock_runtime_resolution(self, monkeypatch):
        ...
        with patch("hermes_agent.hermes_cli.runtime_provider.resolve_provider", return_value="bedrock"), \
             patch("hermes_agent.hermes_cli.runtime_provider._get_model_config", return_value={"provider": "bedrock"}):
    ...
    def test_bedrock_runtime_no_credentials_raises_on_auto_detect(self, monkeypatch):
        ...
        with patch("hermes_agent.hermes_cli.runtime_provider.resolve_provider", return_value="bedrock"), \
             patch("hermes_agent.hermes_cli.runtime_provider._get_model_config", return_value={"provider": "bedrock"}), \
             patch("hermes_agent.hermes_cli.runtime_provider.resolve_requested_provider", return_value="auto"), \
...
class TestProvidersModule:
    ...
    def test_bedrock_alias_in_providers(self):
        from hermes_agent.hermes_cli.providers import ALIASES
    ...
    def test_bedrock_transport_mapping(self):
        from hermes_agent.hermes_cli.providers import TRANSPORT_TO_API_MODE
    ...
    def test_label_override(self):
        from hermes_agent.hermes_cli.providers import _LABEL_OVERRIDES
...
class TestBedrockModelIdDetection:
    ...
    def test_bare_bedrock_id_detected(self):
        from hermes_agent.agent.anthropic_adapter import _is_bedrock_model_id
...
class TestAuxiliaryClientBedrockResolution:
    ...
    def test_bedrock_returns_client_with_credentials(self, monkeypatch):
        ...
        with patch("hermes_agent.agent.anthropic_adapter.build_anthropic_bedrock_client",
                   return_value=mock_anthropic_bedrock):
            from hermes_agent.agent.auxiliary_client import resolve_provider_client, AnthropicAuxiliaryClient
    ...
    def test_bedrock_async_mode(self, monkeypatch):
        ...
        with patch("hermes_agent.agent.anthropic_adapter.build_anthropic_bedrock_client",
                   return_value=MagicMock()):
            from hermes_agent.agent.auxiliary_client import resolve_provider_client, AsyncAnthropicAuxiliaryClient
