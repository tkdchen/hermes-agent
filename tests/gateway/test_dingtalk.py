...
def _fake_dingtalk_optional_sdks(monkeypatch):
    ...
    from hermes_agent.gateway.platforms import dingtalk as dt
...
class TestDingTalkRequirements:
    ...
    def test_returns_false_when_sdk_missing(self, monkeypatch):
        with patch.dict("sys.modules", {"dingtalk_stream": None}), \
             patch("hermes_agent.tools.lazy_deps.ensure", side_effect=ImportError("dingtalk_stream unavailable")):
            monkeypatch.setattr(
...
class TestExtractMedia:
    ...
    def test_audio_rich_text_item_stays_audio(self):
        ...
        from hermes_agent.gateway.platforms.dingtalk import DingTalkAdapter, DINGTALK_TYPE_MAPPING
        from hermes_agent.gateway.platforms.base import MessageType
