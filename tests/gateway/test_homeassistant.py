...
class TestCheckRequirements:
    ...
    @patch("hermes_agent.plugins.platforms.homeassistant.adapter.AIOHTTP_AVAILABLE", False)
...
class TestSendViaRestApi:
    ...
    async def test_send_success(self):
        ...
        with patch("hermes_agent.plugins.platforms.homeassistant.adapter.aiohttp") as mock_aiohttp:
