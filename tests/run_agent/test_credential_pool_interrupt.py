...
from hermes_agent.agent.credential_pool import PooledCredential, STATUS_EXHAUSTED
...
def test_rotate_immediately_when_credential_already_exhausted():
    ...
    with patch("hermes_agent.run_agent.get_tool_definitions", return_value=[]),          patch("hermes_agent.run_agent.check_toolset_requirements", return_value={}),          patch("hermes_agent.run_agent.OpenAI"):
