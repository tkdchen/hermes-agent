...
def test_session_search_lazily_opens_db_when_entrypoint_did_not_pass_one(monkeypatch):
    ...
    hermes_state = ModuleType("hermes_agent.hermes_state")
    hermes_state.SessionDB = FakeSessionDB
    monkeypatch.setitem(sys.modules, "hermes_agent.hermes_state", hermes_state)

    session_search_mod = ModuleType("hermes_agent.tools.session_search_tool")
    ...
    monkeypatch.setitem(sys.modules, "hermes_agent.tools.session_search_tool", session_search_mod)
