...
from hermes_agent.plugins.google_meet.cli import register_cli as _register_meet_cli
from hermes_agent.plugins.google_meet.cli import meet_command as _meet_command
from hermes_agent.plugins.google_meet.tools import (
    MEET_JOIN_SCHEMA,
    MEET_LEAVE_SCHEMA,
    MEET_SAY_SCHEMA,
    MEET_STATUS_SCHEMA,
