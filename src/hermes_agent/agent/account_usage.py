...
from hermes_agent.agent.anthropic_adapter import _is_oauth_token, resolve_anthropic_token
from hermes_agent.hermes_cli.auth import _read_codex_tokens, resolve_codex_runtime_credentials
...
def build_nous_credits_snapshot(account_info) -> Optional[AccountUsageSnapshot]:
    ...
    """
    try:
        from hermes_agent.hermes_cli.nous_account import nous_portal_topup_url
