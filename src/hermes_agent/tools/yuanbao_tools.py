...
def _get_active_adapter():
    ...
    try:
        from hermes_agent.gateway.platforms.yuanbao import get_active_adapter
...
async def search_sticker(query: str = "", limit: int = 10) -> dict:
    ...
    """
    from hermes_agent.gateway.platforms.yuanbao_sticker import search_stickers
...
from hermes_agent.tools.registry import registry, tool_result  # noqa: E402
