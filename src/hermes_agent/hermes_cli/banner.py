...
from hermes_agent.hermes_cli import __version__ as VERSION, __release_date__ as RELEASE_DATE
...
def build_welcome_banner(console: "Console", model: str, cwd: str,
    ...
    try:
        from hermes_agent.hermes_cli.codex_runtime_switch import get_current_runtime
        from hermes_agent.hermes_cli.config import load_config as _load_cfg
    ...
    try:
        ...
        if behind is not None and behind != 0:
            from hermes_agent.hermes_cli.config import get_managed_update_command, recommended_update_command
            if behind > 0:
